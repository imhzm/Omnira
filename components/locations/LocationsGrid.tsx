  ...
  return (
    <section ref={ref} className="section-padding bg-black-primary">
      <div className="container-custom">
        ...
        >
          <div className="p-8 rounded-2xl bg-gradient-dark border border-gold-primary/30">
            <h2 className="text-3xl font-bold mb-6 text-gold-primary text-center">
              تواصل معنا في أي مدينة
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center justify-center space-x-3 space-x-reverse">
                <Phone className="w-5 h-5 text-gold-primary" />
                <span className="text-gray-300">+966 XX XXX XXXX</span>
              </div>
              <div className="flex items-center justify-center space-x-3 space-x-reverse">
                <Mail className="w-5 h-5 text-gold-primary" />
                <span className="text-gray-300">info@omnira.sa</span>
              </div>
              <div className="flex items-center justify-center space-x-3 space-x-reverse">
                <MapPin className="w-5 h-5 text-gold-primary" />
                <span className="text-gray-300">متاح في جميع المدن</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="space-y-16">
          {regions.map((region, regionIndex) => (
            ...
            >
              {/* عنوان المنطقة */}
              <div className="mb-8">
                <h3 className="text-3xl font-bold text-gold-primary mb-2">{region.name}</h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {region.cities.map((city, cityIndex) => (
                  ...
                  >
                    <div className="relative p-6 rounded-xl bg-gradient-dark border border-gold-primary/20 hover:border-gold-primary transition-all duration-300 overflow-hidden">
                      ...
                      <div className="relative flex flex-col items-center text-center space-y-3">
                        <div className="w-12 h-12 rounded-full bg-gold-primary/10 flex items-center justify-center group-hover:bg-gold-primary/20 transition-colors">
                          <MapPin className="w-6 h-6 text-gold-primary" />
                        </div>
                        
                        {/* اسم المدينة */}
                        <h4 className="font-bold text-white group-hover:text-gold-primary transition-colors">
                          {city}
                        </h4>
                      </div>
        ...
        >
          <div className="p-12 rounded-2xl bg-gradient-dark border border-gold-primary/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="px-10 py-4 text-lg border-2 border-gold-primary text-white rounded-lg hover:bg-gold-primary/10 transition-all inline-flex items-center justify-center"
              >
