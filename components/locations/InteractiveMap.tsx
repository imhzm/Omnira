    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-center text-gray-600 max-w-3xl mx-auto mb-12">
          تتوفر خدمات أومنيرا في جميع مناطق المملكة العربية السعودية. انقر على المنطقة لمعرفة المدن التي نخدمها.
        </p>
            ...
            {selectedRegion ? (
              ...
              <div>
                <p className="text-gray-700">
                  تتوفر خدمات أومنيرا في أكثر من 150 مدينة ومحافظة في جميع أنحاء المملكة العربية السعودية.
                </p>
