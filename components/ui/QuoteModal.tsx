                  ...
                  {mode === 'pay' && (
                    <div className="rounded-xl border border-white/10 bg-white/[0.03] p-3 text-center">
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-2">
                        ...
                        <div className="inline-flex items-center gap-1 rounded bg-black border border-white/20 px-2 py-0.5 text-white shadow-sm">
                          ...
                          <span className="font-semibold text-[11px] leading-none">Pay</span>
                        </div>
