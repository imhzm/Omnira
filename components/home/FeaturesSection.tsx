...
const FeatureCard = ({ feature, index, isInView }: FeatureCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative p-8 rounded-3xl bg-[#141418] border border-white/10 hover:border-sage-primary transition-all duration-300 h-full hover:shadow-2xl hover:scale-105">
        {/* Icon */}
